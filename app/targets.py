...
AVAILABLE_TARGETS: dict[str, dict[str, Any]] = {
    ...
    "cox1": {
        ...
        "preview_path": "input/targets/COX_1/Final/3N8Z_A_relax.pdb",
    ...
    "egfr": {
        ...
        "preview_path": "input/targets/EGFR/Final/1M17_A_relax.pdb",
    ...
    "estrogen": {
        ...
        "preview_path": "input/targets/Estrogen_Receptor/Final/7KBS_A_relax.pdb",
    ...
    "sert": {
        ...
        "preview_path": "input/targets/Serotonin_Transporter/Final/6AWP_A_relax.pdb",
